        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((step, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-border bg-white p-7 shadow-[0_1px_3px_rgba(20,20,22,0.04)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_14px_36px_rgba(20,20,22,0.08)]"
            >
              <span className="font-display text-5xl font-semibold leading-none text-brand-subtle transition-colors group-hover:text-brand/20">
                {step.num}
              </span>
