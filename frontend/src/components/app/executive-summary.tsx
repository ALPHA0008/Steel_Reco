    ...
    <section className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-border/60 bg-card p-6">
      ...
      <div className="relative flex flex-1 flex-col">
        ...
        <div className="flex items-center gap-5">
          <HealthGauge score={n.health} size={104} label="" showBand={false} />
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[15.5px] font-semibold leading-snug tracking-tight text-foreground text-balance">
              {n.headline}
            </p>
          </div>
        </div>
        ...
        <div className="mt-5 grid grid-cols-3 gap-3 border-t border-border/50 pt-4">
          <div>
            ...
            <div className="tnum mt-0.5 text-[17px] font-semibold" style={{ color: "var(--danger)" }}>
          ...
          <div>
            ...
            <div className="tnum mt-0.5 text-[17px] font-semibold text-foreground">
          ...
          <div>
            ...
            <div className="tnum mt-0.5 text-[17px] font-semibold text-success">
        ...
        <button
          ...
          className={cn(
            "group mt-4 flex w-full items-center gap-2.5 rounded-xl bg-foreground px-4 py-2.5 text-left text-background transition-all",
